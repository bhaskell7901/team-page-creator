...
Employee.prototype.getHtmlCard = function() {
    new Promise((cardReturn, reject) => {
        ...
        if( type === "Manager" ){
            ...
            employeeHtmlDataList += `<li class="list-group-item"><em>Office: </em>${this.officeNumber}</li>`;
        }
        else if(type === "Engineer" ){
            employeeCardColorClass = "danger";
            employeeCardIconColorClass = "#C5929D";
            employeeIconClass = "server";
            employeeHtmlDataList += `<li class="list-group-item"><em>GitHub: </em><a href="https://github.com/${this.gitHub}" target="_blank">${this.gitHub}</a></li>`;
        }
        else if(type === "Intern" ){
            employeeCardColorClass = "warning";
            employeeCardIconColorClass = "#8C8347";
            employeeIconClass = "person-lines-fill";
            employeeHtmlDataList += `<li class="list-group-item"><em>School: </em>${this.school}</li>`;
        }
        else {
