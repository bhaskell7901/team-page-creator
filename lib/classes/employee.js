...
Employee.prototype.getHtmlCard = function() {
    ...
    var employeeHtmlDataList = `<li class="list-group-item"><em>ID: </em>${this.emplId}</li>
    ...
    return `<div class="card border-${employeeCardColorClass} text-bg-${employeeCardColorClass} col-2 align-self-center" style="width: 18rem; margin: 10px;">
    <div class="card-body">
